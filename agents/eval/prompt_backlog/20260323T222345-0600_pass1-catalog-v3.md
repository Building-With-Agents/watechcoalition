# Extraction eval run — 2026-03-23T22:23:45-06:00 (America/Denver)

## Metadata

- **Run label:** pass1-catalog-v3
- **Git (short):** 70d7aad0
...
- **Snapshot schema:** `1.0`
- **Wall runtime (s):** 1124.167

## Aggregate metrics

- **Skills** — precision: 0.1628, recall: 0.3801
- **Skills counts** — GT: 221, pred: 516, matched: 84
- **Tools** — precision: 0.7603, recall: 0.7244
- **Tools counts** — GT: 127, pred: 121, matched: 92
- **Total tokens (skills LLM):** 68597
- **Total cost USD (estimate):** 0.47841
- **Total latency ms (sum per job):** 1001259
