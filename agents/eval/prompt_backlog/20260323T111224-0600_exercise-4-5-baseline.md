# Extraction eval run — 2026-03-23T11:12:24-06:00 (America/Denver)

## Metadata

- **Run label:** exercise-4-5-baseline
- **Git (short):** b7ea71da
...
- **Snapshot schema:** `1.0`
- **Wall runtime (s):** 890.264

## Aggregate metrics

- **Skills** — precision: 0.1685, recall: 0.4118
- **Skills counts** — GT: 221, pred: 540, matched: 91
- **Tools** — precision: 0.5424, recall: 0.2520
- **Tools counts** — GT: 127, pred: 59, matched: 32
- **Total tokens (skills LLM):** 78603
- **Total cost USD (estimate):** 0.623439
- **Total latency ms (sum per job):** 839311
...
- skill_name: short name of the skill (e.g. "Python", "Leadership") — alias "label" is accepted
...
Return JSON with a "skills" array. Each skill must have: skill_name (or label), type, confidence, required_flag (or null), source_span (text, field_source, start_char, end_char).
```
