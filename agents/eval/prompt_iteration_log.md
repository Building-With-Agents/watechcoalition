...
- **Harness changes:** `extraction_eval_core.py`, `snapshot_schema.py`, `run_extraction_eval.py`, `streamlit_eval_app.py`, `agents/eval/tests/test_extraction_eval_core.py`; legacy `extraction_eval.py` aligned only via shared helpers as above.
