...
``RecordEnriched`` (Week 5 lite, issue #87) includes ``batch_id``, batch
counts, and ``spam_tier_counts`` (issue #86); this stub sets
``triggered_by_batch_id`` from that envelope.
