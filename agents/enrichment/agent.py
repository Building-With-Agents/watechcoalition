...
Walking skeleton: loads fixture_enriched.json, returns ONLY the single record matching posting_id in payload.
"""
...
FIXTURE_PATH = Path(__file__).resolve().parent.parent / "data" / "fixtures" / "fixture_enriched.json"
AGENT_ID = "enrichment"
...
class EnrichmentAgent(BaseAgent):
    """Classifies role/seniority, quality, spam; stub returns single fixture record by posting_id."""
