...
Walking skeleton: loads fixture_skills_extracted.json, returns ONLY the single record matching posting_id in payload.
"""
...
class SkillsExtractionAgent(BaseAgent):
    """Extracts skills via LLM; stub returns single fixture record by posting_id."""
