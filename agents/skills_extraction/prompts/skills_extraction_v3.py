...
- Limit your extraction to the top 5 to 15 most important skills. Be ruthless in your filtering. Do NOT output exhaustive lists of minor keywords.
...
- Before returning an empty skills array, double-check the title, requirements, and responsibilities for explicit hard skills, methodologies, certifications, or domain skills. Include those that survive the 5–15 cap and the strict-core rules above; do not return empty solely because soft skills were suppressed. Total count must never exceed 15—drop minor or tertiary keywords first.
