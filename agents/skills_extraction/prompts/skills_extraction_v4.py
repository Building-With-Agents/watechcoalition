...
- Before returning an empty skills array, double-check the title, requirements, and responsibilities for explicit hard skills, methodologies, certifications, or domain skills. Include those that survive the 10–25 cap and the strict-core rules above; do not return empty solely because soft skills were suppressed. Total count must never exceed 25—drop minor or tertiary keywords first.
